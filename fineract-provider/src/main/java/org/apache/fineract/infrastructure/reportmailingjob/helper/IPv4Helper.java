...
public class IPv4Helper {
     ...
     */
     private final static Logger logger = LoggerFactory.getLogger(IPv4Helper.class);
    ...
    public static boolean applicationIsRunningOnLocalMachine() {
        ...
        try {
            ...
            //Should be covered in Illegal catch Checkstyle where we remove all use of Exception class in it's most
            //general form
            logger.error("Problem occurred in applicationIsRunningOnLocalMachine function",exception);
         }
